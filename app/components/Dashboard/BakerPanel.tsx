...
import rpc, { TezosCommitProps } from '../../utils/padaria/rpc'
            ...
            <Chip
              label={
                bakerInfo.balance !== undefined
                  ? utils.parseTEZWithSymbol(Number(bakerInfo.balance))
                  : '...'
              }
              color="primary"
                ...
                label={
                  bakerInfo.staking_balance
                    ? utils.parseTEZWithSymbol(
                        Number(bakerInfo.staking_balance)
                      )
                    : '...'
                }
                color="primary"
              ...
              <Chip
                label={
                  bakerInfo.staking_balance
                    ? utils.getTotalRolls(
                        bakerInfo.staking_balance,
                        rpc.networkConstants.tokens_per_roll
                      )
                    : '...'
                }
                color="primary"

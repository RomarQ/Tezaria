...
import {
  SetBakerKeysPrototype,
  ClearUserDataPrototype
    ...
    <div className={classes.root}>
      <div className={classes.container}>
        <div className={classes.header}>
          <Blockies scale={10} seed={keys.pkh} className={classes.blockie} />
          <Chip label={keys.pkh} className={classes.pkh} variant="outlined" />
        </div>
        <form
          className={classes.form}
          onSubmit={keys.encrypted ? onDecryptedSubmit : onEncryptedSubmit}
        >

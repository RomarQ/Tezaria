...
import operations, { UnsignedOperationProps } from '../../utils/padaria/operations';
import { TransactionDestination } from '../../utils/padaria/operations';
                                ...
                                InputProps={{
                                    endAdornment: (
                                        <InputAdornment
                                            ...
                                            position="end"
                                        >
                                            {utils.parseTEZWithSymbol(transaction.amount ? Number(transaction.amount) : 0)}
                                        </InputAdornment>
                                    ),
                                }}
                                inputProps={{
